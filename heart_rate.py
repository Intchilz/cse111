...
def area_of_rectangle(frm_main):
    
    width_label = Label(frm_main, text="Width: ")
    width = IntEntry(frm_main, width=4, lower_bound=12, upper_bound=90)
    
    height_label = Label(frm_main, text="Height: ")
    height = IntEntry(frm_main, width=4, lower_bound=12, upper_bound=90)
    
    area_label = Label(frm_main, text="Area of rectangle:")
    area_label.grid( row=3, column=0,  padx=3, pady=3)
    
    width_label.grid(      row=4, column=0, padx=3, pady=3)
    width.grid(      row=4, column=1, padx=3, pady=3)
    
    height_label.grid(      row=4, column=3, padx=3, pady=3)
    height.grid(      row=4, column=4, padx=3, pady=3)
    
    ans_label = Label(frm_main, width=3)
    ans_label.grid(  row=5, column=0)
    
    
    
    answer_label = Label(frm_main, text="Answer: ")
    answer_label.grid( row=5, column=0, padx=3, pady=3)
    
    ans_label = Label(frm_main, width=3)
    ans_label.grid(  row=5, column=1, padx=3, pady=3)
    ...
    # that the computer will call the calculate function
    # when the user changes the text in the entry box.
    width.bind("<KeyRelease>", calculate)
    height.bind("<KeyRelease>", calculate)
