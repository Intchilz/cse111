def main():
    ...
    perieodic_table = make_periodic_table()
    
    for inner_list in perieodic_table:
        name_index = inner_list[element_name_index]
        mass_index = inner_list[atomic_mass_index]
        print(f'{name_index} {mass_index}')
